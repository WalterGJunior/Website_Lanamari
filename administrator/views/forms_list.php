...
<body>
    ...
    <div class="CSSTableGenerator" > 
        <table width="100%">
            ...
            <?php
$consulta = mysql_query("SELECT * FROM tb_formularios ORDER BY tx_id"); // query que busca todos os dados da tabela COBRANÇA
...
while($campo = mysql_fetch_array($consulta)){ // laço de repetiçao que vai trazer todos os resultados da consulta
    ...
    <tr class="backgroundCenter">
        ...
        <td style="text-align:center">
            <a href="forms_list.php?deleteReg=yes&pag=forms_list.php?&tx_id=<?php echo $campo['tx_id']; // mostrando o campo NOME da tabela ?>"><input  style="width:50px; padding: 5px 5px;" class="but but-error but-shadow but-rc" type="button" name="excluir" value="Excluir" /> </a> 
        </td>
    </tr>
    <?php } ?>
</table>
