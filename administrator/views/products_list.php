...
while($campo = mysql_fetch_array($query)){ // laço de repetiçao que vai trazer todos os resultados da consulta
  ...
  <tr class="backgroundCenter">
    ...
    <td style="text-align:center">
      ...
      <a href="products_list.php?deleteReg=yes&pag=products_list.php?&tx_id=<?php echo $campo['tx_id']; // mostrando o campo NOME da tabela ?>"><input  style="width:50px; padding: 5px 5px;" class="but but-error but-shadow but-rc" type="button" name="excluir" value="Excluir" /> </a> 

      <a href="products.php?tx_id=<?php echo $campo['tx_id']; // mostrando o campo NOME da tabela ?>"> <input  style="width:50px; padding: 5px 5px;" class="but but-primary but-shadow but-rc" type="button" name="editar" value="Editar" /></a>
    </td>
  </tr>
  <?php } ?>
</table>
