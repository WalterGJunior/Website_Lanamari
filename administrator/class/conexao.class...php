...
class conexao
{
    ...
    */
    ...
    private $db_user = 'polar752_whilton'; // usuario do banco
    private $db_pass = 'whilton1983'; // senha do usuario do banco
    private $db_name = 'polar752_londongourmet'; // nome do banco
