...
protected function sanitizeString($string) {
    ...
    // matriz de entrada
    $what = array( 'ä','ã','à','á','â','ê','ë','è','é','ï','ì','í','ö','õ','ò','ó','ô','ü','ù','ú','û','À','Ã','Á','É','Í','Ó','Ú','ñ','Ñ','ç','Ç','-','(',')',',',';',':','|','!','"','#','$','%','&','/','=','?','~','^','>','<','ª','º' );
    ...
    protected function normalizeFilename($filename) {
        if (isset($this->config['filenameChangeChars']) &&
            ...
            $filename = '1.jpg'; //strtr($filename, $this->config['filenameChangeChars']);
        return $filename;
    }
    ...
    protected function normalizeDirname($dirname) {
        ...
        return self::sanitizeString($dirname);
    }
